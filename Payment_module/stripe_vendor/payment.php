...
if(isset($_POST["token"]))
{
  ...
  \Stripe\Stripe::setApiKey('sk_test_51H26jMLohR7y9hpMQJKlkaeSnVOfNsKSkvKZfV2JDPPbyQnHegz13UWOboLL5m68N6J7cyuM9dYqJtt21qGQuMx300Y0HHOHhZ');
  ...
  foreach($_SESSION["shopping_cart"] as $keys => $values)
  {
   ...
   $query = "INSERT INTO order_item (order_id, order_item_name, order_item_quantity, order_item_price) 
